...
$(function () {
  ...
  var box = document.querySelector('.img-box'); // 	$imgBox.hover(function(evt){
  ...
  $(document).mousemove(function (evt) {
    var left = evt.pageX - $imgBox.offset().left - $float.width() / 2;
    var top = evt.pageY - $imgBox.offset().top - $float.height() / 2;
